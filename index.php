...
<body>
    <div class="container">
                    ...
                    <div class="wrap">
                        ...
                        <div class="search">
                            ...
                            <button aria-placeholder="">
                                <img src="assets/search-icon.png" alt="검색" onclick="">
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                ...
                                function performSearch() {
                                    ...
                                    posts.forEach(function(post) {
                                        const postId = post.getAttribute("id").toLowerCase();
                                        if (postId.includes(searchText)) {
                                            window.location.href = "#" + postId;
                                            return; // Exit loop once the first matching post is found
                                        }
                                    });
                                }
        ...
        <ul class="nav nav-pills tabs" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="./pages/upload.html" class="nav-link" id="pills-report-tab">
            ...
            <li class="nav-item" role="presentation">
                <a href="./pages/myInfo.php" class="nav-link" id="pills-news-tab">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 0 24 24" width="48px" fill="#000000">
    ...
    <script>
        document.getElementById('heartButton').addEventListener('click', function() {
            var emptyHeart = document.querySelector('#heartButton img[alt="Empty Heart"]');
            var fullHeart = document.querySelector('#heartButton img[alt="Full Heart"]');
